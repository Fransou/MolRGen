...
from molrgen.server_utils.server_endpoints.get_reward import (
    get_reward_endpoint,
)
from molrgen.server_utils.server_setting import MolecularVerifierServerSettings
...
class ReinventTrainingService:
    ...
    async def train(
        ...
        cmd = [
            "python",
            "-m",
            "molrgen.baselines.reinvent.rl_opt_rpo",
...
def register_mcp_tools(
    ...
    async def train_reinvent_generator(
        ...
        Example:
            ```python
            from molrgen.reward.verifiers.generation_reward.input_metadata import GenerationVerifierInputMetadataModel
